...
defaults.TextYAlignment = "Center" -- Alignment of the text on the line, only makes a difference if the line has variable text sizes
...
defaults.AnimateStyle = "Wiggle"
defaults.AnimateStyleTime = .5 -- How long it takes for an entrance style to fully execute
defaults.AnimateStyleNumPeriods = 1 -- Used differently for each entrance style
defaults.AnimateStyleAmplitude = 0.3 -- Used differently for each entrance style
