...
function module.Move2(p)
	...
	SharedFunctions:FireAllDistanceClients(
		...
		script.Name,
		200,
		{ PlantCFrame = PlantCFrame, Character = c, Function = "Move2" }
	)
...
function module.Move4(p)
	...
	local _ = (
		c.HumanoidRootPart:FindFirstChild("ExplosionCharge")
		and c.HumanoidRootPart:FindFirstChild("ExplosionCharge"):Destroy()
	)
...
function module.Plant(p)
	...
	SharedFunctions:FireAllDistanceClients(
		...
		script.Name,
		500,
		{ PlantCFrame = PlantCFrame, Character = c, Function = "Plant" }
	)
end
