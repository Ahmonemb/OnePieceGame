...
local Races = {
	...
	{Name = "Mink", Chance = 80, Variants = {
		{Name = "Reindeer", Chance = 50},
		{Name = "Rabbit", Chance = 100}
	}},
	{Name = "Fishman", Chance = 90, Variants = {
		{Name = "Octopus", Chance = 50},
		{Name = "Octopus", Chance = 100}
	}},
	{Name = "Skypian", Chance = 100, Variants = {
...
local function SpinVariant(Player)
	...
	if not Race.Variants then return end
	...
	if typeof(Variant) == "table" then Variant = Variant.Name end
...
function module.GetPassive(Player)
