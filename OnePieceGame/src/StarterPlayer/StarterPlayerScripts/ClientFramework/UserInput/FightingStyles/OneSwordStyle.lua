...
local module = {
	...
	["Z"] = {
		["Held"] = function(p)
			...
			if cooldowns:GetAttribute("CaliberPhoenix") then return end
	...
	["X"] = {
		["Held"] = function(p)
			...
			if cooldowns:GetAttribute("RapidSlashes") then return end
			collectionService:AddTag(c,"Aim")
			G.Aim(p,.3)
	...
	["C"] = {
		["Held"] = function(p)
			...
			if cooldowns:GetAttribute("LionSong") then return end
			collectionService:AddTag(c,"Aim")
			G.Aim(p,.3)
