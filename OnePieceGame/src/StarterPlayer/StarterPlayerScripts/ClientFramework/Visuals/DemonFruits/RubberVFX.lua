	...
	for i = 1,2 do
		...
		coroutine.wrap(function()
			...
			for j = 1,2 do
				...
				SideWind.CFrame = Root.CFrame * CFrame.new(Offset,-0.5,0) * CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(180),math.rad(Rot))
...
function module.Move3(Data)
	...
	local function GroundTouched(RootPos, PartHit)
		...
		Smoke.CFrame = Root.CFrame * CFrame.new(0,-2.5,0) * CFrame.fromEulerAnglesXYZ(math.rad(90),0,0)
		Smoke.Parent = Visual
	...
	--[[ shockwave5 ]]--
	local shockwave5 = VFXEffects.Mesh.shockwave5:Clone()
	shockwave5.CFrame = Root.CFrame * CFrame.fromEulerAnglesXYZ(0, math.rad(90), 0)
	shockwave5.Size = Vector3.new(25, 50, 25)
	shockwave5.Transparency = 0
	shockwave5.Material = "Neon"
	shockwave5.BrickColor = BrickColor.new("Institutional white")
