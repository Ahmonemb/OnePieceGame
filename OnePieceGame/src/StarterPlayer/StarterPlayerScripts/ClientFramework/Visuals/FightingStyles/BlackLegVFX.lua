...
function module.Move1(Data)
	...
	local tween = TweenService:Create(Ball, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Size"] = Ball.Size * (7)})
	tween:Play()
	tween:Destroy()
	...
	local tween = TweenService:Create(beam, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["CFrame"] = beam.CFrame * CFrame.new(0,15,0), ["Transparency"] = 1, ["Size"] = Vector3.new(0,50,0)})
	tween:Play()
	tween:Destroy()
	...
	ring2.Parent = Visual
	Debris:AddItem(ring2, .8)

	local tween = TweenService:Create(ring2, TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["CFrame"] = ring2.CFrame * CFrame.new(0,0,-10), ["Transparency"] = 1, ["Size"] = Vector3.new(20, 20, 0.05)})
	tween:Play()
	tween:Destroy()
	...
	shockwave5.Transparency = .5
	shockwave5.Material = "Neon"
	shockwave5.Color = Color3.fromRGB(255, 255, 255)
	shockwave5.Parent = Visual
	Debris:AddItem(shockwave5, .35)

	local tween = TweenService:Create(shockwave5, TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Size"] = Vector3.new(25, 5, 25)})
	tween:Play()
	tween:Destroy()
...
function module.Move2(Data)
	...
	local tween = TweenService:Create(shock,TweenInfo.new(.5,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{Size = Vector3.new(35,50,35), CFrame = shock.CFrame*CFrame.new(0,25,0)*CFrame.Angles(0,math.pi/2,0)})
	tween:Play()
	tween:Destroy()
	coroutine.wrap(function()
		wait(.2)
		local tween = TweenService:Create(shock,TweenInfo.new(.2,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{Size = Vector3.new(0,80,0), Color = Color3.fromRGB(189, 189, 189)})
		tween:Play()
		tween:Destroy()
	...
	local tween = TweenService:Create(shockwave5, TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Size"] = Vector3.new(40, 5, 40)})
	tween:Play()
	tween:Destroy()
...
function module.Move3(Data)
	...
	for _ = 1,15 do
		...
		local tween = TweenService:Create(ring2, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["CFrame"] = ring2.CFrame * CFrame.new(0,0,-2), ["Transparency"] = 1, ["Size"] = Vector3.new(10, 10, 0.05)})
		tween:Play()
		tween:Destroy()	
		...
		CrashSmoke.CanCollide = false
		CrashSmoke.Position = Root.Position
		CrashSmoke.Smoke.Size = NumberSequence.new{NumberSequenceKeypoint.new(0, 1), NumberSequenceKeypoint.new(1, 3)}
		CrashSmoke.Size = Vector3.new(15,0,15)
		CrashSmoke.Smoke.Speed = NumberRange.new(5,15)
		...
		local tween = TweenService:Create(shockwave5, TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["CFrame"] = shockwave5.CFrame * CFrame.Angles(0,math.pi,0), ["Transparency"] = 1, ["Size"] = Vector3.new(20, 3.5, 20)})
		tween:Play()
		tween:Destroy()
		Debris:AddItem(shockwave5, 0.35)
...
function module.Move4(Data)
	...
	local tween = TweenService:Create(beam.Mesh, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Scale"] = Vector3.new(0,0,60)})
	tween:Play()
	tween:Destroy()
	Debris:AddItem(beam, 0.25)
	...
	local tween = TweenService:Create(ring2, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Size"] = Vector3.new(20, 20, 0.05)})
	tween:Play()
	tween:Destroy()	
	...
	local tween = TweenService:Create(shockwaveOG, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["CFrame"] = shockwaveOG.CFrame * CFrame.fromEulerAnglesXYZ(0,5,0), ["Transparency"] = 1, ["Size"] = Vector3.new(25, 5, 25)})
	tween:Play()
	tween:Destroy()	
	Debris:AddItem(shockwaveOG, .25)	
	...
	local tween = TweenService:Create(shockwaveOG2, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["CFrame"] = shockwaveOG.CFrame * CFrame.fromEulerAnglesXYZ(0,5,0), ["Transparency"] = 1, ["Size"] = Vector3.new(30, 15, 30)})
	tween:Play()
	tween:Destroy()	
	Debris:AddItem(shockwaveOG2, .25)
	...
	local tween = TweenService:Create(ring3, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Size"] = Vector3.new(30, 30, 0.05)})
	tween:Play()
	tween:Destroy()	
	Debris:AddItem(ring3, .5)
