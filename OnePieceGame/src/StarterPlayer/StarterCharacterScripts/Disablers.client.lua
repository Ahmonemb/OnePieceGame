...
game:GetService("RunService").Heartbeat:Connect(function()
	...
	if Char:FindFirstChild("StopStun") == nil and Char:FindFirstChild("Stun") == nil and Char:FindFirstChild("Running") == nil and Char:FindFirstChild("NoJump") == nil and Char:FindFirstChild("Blocking") == nil then
